...
//Name: sink.ma
//Last modified: Thu, Oct 15, 2015 06:57:16 PM
//Codeset: 1252
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 17.977248192463172 23.915946306939396 -9.6393159055422917 ;
	setAttr ".r" -type "double3" -49.538352730337358 1558.1999999986599 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "82F2FF8F-4253-A10D-7693-5E98BE85F40C";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 31.433586360119975;
...
createNode transform -n "polySurface1" -p "pCube4";
	rename -uid "156FA777-49A2-EE60-B76D-E6A340932C95";
	setAttr ".t" -type "double3" 0 2.5 0 ;
	setAttr ".s" -type "double3" 1.0858882814677311 5.2435482606648689 0.86936771982260208 ;
	setAttr ".rp" -type "double3" 0 0.5 0 ;
	setAttr ".sp" -type "double3" 0 0.5 0 ;
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	rename -uid "BB14CE43-4858-7848-936F-488AA73DCA7A";
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt[0:7]" -type "float3"  0 0 -1 0 0 -1 0 -0.30928946 
		-1 0 0 -1 0 -0.30928946 1.074976 0 0 1 0 0 0.92502427 0 0 1;
...
createNode transform -n "polySurface5" -p "pCube4";
	...
	setAttr ".t" -type "double3" 0.22763487733518328 0 -12.492417335510254 ;
	setAttr ".s" -type "double3" 1.4160588180134663 1.2987105168561961 1.618499129782387 ;
...
createNode transform -n "pasted__polySurface5" -p "|group3|pasted__pCube4";
	...
	setAttr ".t" -type "double3" 0.21802339381044034 0 -13.951035206307678 ;
	setAttr ".s" -type "double3" 1.4160588180134663 1.2987105168561961 1.618499129782387 ;
...
createNode transform -n "pasted__pasted__pasted__pCylinder1" -p "|group6|pasted__group5|pasted__pasted__group4";
	...
	setAttr ".t" -type "double3" 9.051263527642627 11.482021751336717 -0.017605084126927739 ;
	setAttr ".r" -type "double3" 90 0 0 ;
	setAttr ".s" -type "double3" 0.36139246964983257 0.23947171327944197 1.5468049397944743 ;
...
createNode transform -n "pasted__polySurface3" -p "|group8|pasted__pCube4";
	...
	setAttr ".t" -type "double3" -1.1313906757089507 0 0.022808293789312373 ;
	setAttr ".s" -type "double3" 1.6524882641063217 1.297159368717423 0.9724711476634984 ;
	setAttr ".rp" -type "double3" -3 3 0 ;
	setAttr ".sp" -type "double3" -3 3 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AB0C8A68-41F3-2F6F-ED8A-7FA47E5FD88C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "FE6EDD29-4ECF-ACAC-E714-85AF2FFE919E";
createNode displayLayer -n "defaultLayer";
	rename -uid "A153FD72-43AF-AE52-B1F4-D09BCAE824B3";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "3E6014D7-497B-D13E-D23C-8383FB032C36";
...
createNode groupId -n "groupId12";
	rename -uid "DFC39EFA-4CB4-0BEE-137B-5685953CEF82";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts7";
	rename -uid "77F6847B-47EF-20B0-DF1C-EAB3496396E4";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:5]";
...
connectAttr ":initialShadingGroup.mwc" "pasted__polySurfaceShape5.iog.og[0].gco"
		;
connectAttr "pasted__groupId23.id" "pasted__polySurfaceShape5.iog.og[0].gid";
connectAttr "pasted__groupParts13.og" "pasted__polySurfaceShape5.i";
